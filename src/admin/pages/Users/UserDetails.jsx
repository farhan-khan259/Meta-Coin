...
//               `http://localhost:3005/api/admin/users/${userId}`
//             );
...
//           `http://localhost:3005/api/addBalanceByAdmin`,
//           {
//             userId: user._id,
//             balance: amount,
//           }
...
//       try {
//         const response = await axios.post(
//           `http://localhost:3005/api/addSubtractByAdmin`,
//           {
//             userId: user._id,
//             balance: amount,
//           }
...
//     try {
//       const response = await axios.post(
//         `http://localhost:3005/api/adminLoginUserAccount`,
//         {
//           userId: user._id,
//         }
//       );
...
//       try {
//         const response = await axios.post(
//           `http://localhost:3005/api/admindeleteplainuser`,
//           { userId: user._id }
//         );
